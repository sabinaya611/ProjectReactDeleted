    ...
    <div className="services-container">
      ...
      <div className="services-list">
        <div className="service">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAZJylui77n8Hs_ybNHdVe3D3DO0KzcAtvRw&usqp=CAU" alt="Tours" />
          <h3>Tours</h3>
        ...
        <div className="service">
          <img src="" alt="Flight Booking" />
          <h3>Flight Booking</h3>
          <p>Book your flights hassle-free with our easy-to-use flight booking system.</p>
        </div>
        <div className="service">
          <img src="https://example.com/train_booking.jpg" alt="Train Booking" />
          <h3>Train Booking</h3>
